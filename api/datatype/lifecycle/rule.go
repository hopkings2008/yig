...
func (r Rule) IsSetExpiredObjectDeleteMarker() bool {
	if r.Expiration != nil {
		return r.Expiration.IsSetExpiredObjectDeleteMarker()
	}
	return false
}

func (r *Rule) SetFilterPrefix(prefix *string) {
	...
	newPrefix := *prefix
	r.Filter.Prefix = &newPrefix
}

func (r *Rule) SetExpirationDays(days int) {
	if r.Expiration == nil {
		r.Expiration = &Expiration{}
	}
	r.Expiration.Days = ExpirationDays(days)
}

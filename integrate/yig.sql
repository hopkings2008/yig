...
ALTER TABLE gc ADD COLUMN meta varchar(255) DEFAULT "" AFTER triedtimes;
ALTER TABLE gcpart ADD COLUMN meta varchar(255) DEFAULT "" AFTER version;
ALTER TABLE multipartpart ADD COLUMN meta varchar(255) DEFAULT "" AFTER uploadtime;
ALTER TABLE objectpart ADD COLUMN meta varchar(255) DEFAULT "" AFTER version;
